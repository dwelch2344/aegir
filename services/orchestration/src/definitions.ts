...
export const selectHealthTaskDefs: TaskDef[] = [
  {
    ...
    description:
      "Validates agent information and checks residency eligibility for Select Health",
    retryCount: 1,
    retryLogic: "FIXED",
    retryDelaySeconds: 5,
    timeoutSeconds: 30,
  ...
  },
  {
    ...
    description:
      "Creates Sircon DOI affiliation with Health First for the agent",
    retryCount: 2,
    retryLogic: "FIXED",
  ...
  },
  {
    ...
    description:
      "Sends contracting request email to Select Health and updates Agent Intel",
    retryCount: 2,
    retryLogic: "FIXED",
    retryDelaySeconds: 10,
    timeoutSeconds: 60,
  ...
  },
  {
    ...
    description:
      "HF countersigns DocuSign, agent training, and Andrew Freeze signs",
    retryCount: 1,
    retryLogic: "FIXED",
    retryDelaySeconds: 5,
    timeoutSeconds: 60,
  ...
  },
  {
    ...
    description:
      "Waits for Select Health carrier processing and document distribution",
    retryCount: 1,
    retryLogic: "FIXED",
    retryDelaySeconds: 5,
    timeoutSeconds: 60,
  ...
  },
  {
    ...
    description:
      "Files documents, completes Agent Intel record, sends RTS confirmation",
    retryCount: 2,
    retryLogic: "FIXED",
    retryDelaySeconds: 10,
    timeoutSeconds: 60,
...
export const agentChatTaskDefs: TaskDef[] = [
  ...
  },
  {
    ...
    description:
      "Invokes the Claude CLI with conversation context and user message",
    retryCount: 1,
    retryLogic: "FIXED",
    retryDelaySeconds: 5,
    timeoutSeconds: 120,
  ...
  },
  {
    ...
    description:
      "Delivers the Claude response back to the agents service as an assistant message",
    retryCount: 1,
    retryLogic: "FIXED",
    retryDelaySeconds: 3,
    timeoutSeconds: 15,
...
export const agentChatWorkflow: WorkflowDef = {
  ...
  description:
    "Long-lived agent chat — loops waiting for human messages until closed",
  version: 1,
  schemaVersion: 2,
  ownerEmail: agentChatOwner,
  tasks: [
...
export const taskDefs: TaskDef[] = [
  {
    ...
    description:
      "Validates the identity payload for a new user onboarding request",
    retryCount: 2,
    retryLogic: "FIXED",
    retryDelaySeconds: 10,
    timeoutSeconds: 30,
...
export const onboardingWorkflow: WorkflowDef = {
  ...
  description:
    "End-to-end user onboarding: validate identity, provision account, send welcome email",
  version: 1,
  schemaVersion: 2,
  ownerEmail: "platform@aegir.local",
  tasks: [
